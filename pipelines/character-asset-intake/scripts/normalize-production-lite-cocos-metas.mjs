...
const source = JSON.parse(
  await readFile(
    path.join(repositoryRoot, "examples/production-lite-character/source/character-source.json"),
    "utf8",
  ),
);
const images = [
  ...
  {
    file: "reference/reference-composite.png",
    width: source.sourceCanvas.width,
    height: source.sourceCanvas.height,
  },
  {
    file: "reference/reconstructed-rest.png",
    width: source.sourceCanvas.width,
    height: source.sourceCanvas.height,
  },
  {
    file: "reference/reconstruction-diff.png",
    width: source.sourceCanvas.width,
    height: source.sourceCanvas.height,
  },
];
