...
export const MULTI_ATTACHMENT_BRIDGE_PLAN = {
  "planVersion": "1.0.0",
  "rigId": "production-lite-character-layout",
  "defaultStateId": "all-attachments",
  "base": {
    "planVersion": "1.0.0",
    "rigId": "production-lite-character-layout",
    "sourceCanvas": {
  ...
  "states": [
    ...
    {
      "stateId": "attachment-group-a-only",
      "hudLabel": "Cap Only",
      "enabledAttachmentIds": [
        "cap-back",
        "cap-front"
    ...
    {
      "stateId": "attachment-group-b-only",
  ...
  "attachments": [
    {
      ...
      "slotId": "headwear",
      "parentPartId": "head",
      "resourcePath": "production-lite-head-accessories/attachments/cap-back/spriteFrame",
      "transform": {
        "position": {
          "x": 0,
          "y": 0
      ...
      "enabledByState": {
        "base-only": false,
        "attachment-group-a-only": true,
        "attachment-group-b-only": false,
    ...
    },
    {
      ...
      "slotId": "face-accessory",
      "parentPartId": "head",
      "resourcePath": "production-lite-head-accessories/attachments/sunglasses/spriteFrame",
      "transform": {
        "position": {
          "x": 0,
          "y": 0
      ...
      "enabledByState": {
        "base-only": false,
        "attachment-group-a-only": false,
        "attachment-group-b-only": true,
        "all-attachments": true
      }
    },
    {
      ...
      "slotId": "headwear",
      "parentPartId": "head",
      "resourcePath": "production-lite-head-accessories/attachments/cap-front/spriteFrame",
      "transform": {
        "position": {
          "x": 0,
          "y": 0
...
} as unknown as MultiAttachmentBridgePlan;
